...
export const PluginLifecycleProtocolSchemas = {
  ...
  DevicePairConnectivityInspectParams: devices.DevicePairConnectivityInspectParamsSchema,
  DevicePairConnectivityInspectResult: devices.DevicePairConnectivityInspectResultSchema,
  DevicePairConnectivityPlanParams: devices.DevicePairConnectivityPlanParamsSchema,
  DevicePairConnectivityPlanResult: devices.DevicePairConnectivityPlanResultSchema,
