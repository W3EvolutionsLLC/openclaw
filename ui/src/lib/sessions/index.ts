...
export function createSessionCapability(gateway: SessionGateway): SessionCapability {
  ...
  return {
    ...
    createBulkMessageOperation: operations.createBulkMessageOperation,
    listSessionOperations: operations.listSessionOperations,
    getSessionOperation: operations.getSessionOperation,
    retrySessionOperation: operations.retrySessionOperation,
