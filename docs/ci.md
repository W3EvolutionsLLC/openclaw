...
- Core unit fast/support lanes run separately; source/security, media/UI, and gateway-core each use two deterministic file-weighted stripes; core runtime infra splits into process, shared, hooks, secrets, and three cron domain shards.
